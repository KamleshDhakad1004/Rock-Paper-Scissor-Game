...
function changeUserScore(uscore) {
  document.getElementById("myscore").innerHTML = uscore;
}
let pcScore = 0;
...
let userrock = document.getElementById("rockwinmy");
let userpaper = document.getElementById("handwinmy");
let userscissor = document.getElementById("scissorwinmy");

let pcrock = document.getElementById("rockwinpc");
